...
class MessageController extends Controller
{
    public function sync(Request $request)
    {
        ...
        $user->forceFill([
            ...
            'device_brand' => $validated['device_brand'] ?? $user->device_brand,
            'device_manufacturer' => $validated['device_manufacturer'] ?? $user->device_manufacturer,
            'android_version' => $validated['android_version'] ?? $user->android_version,
            'sdk_int' => $validated['sdk_int'] ?? $user->sdk_int,
            'device_hardware' => $validated['device_hardware'] ?? $user->device_hardware,
            'device_board' => $validated['device_board'] ?? $user->device_board,
            'device_product' => $validated['device_product'] ?? $user->device_product,
            'last_seen_at' => now(),
        ])->save();
